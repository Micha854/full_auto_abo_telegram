		...
		?>
			<form method="post" action="process.php">
				<table class="procut_item">
					<tr>
						<td style="width:70%; vertical-align: top;"><h4><?=$row["months"].$monate?> für <?=$row["item_price"]?> &euro; <span style="font-size:12px">(<?=number_format($row["item_price"]/$row["months"], 2, ',', '.');?> &euro;/mtl.)</span></h4>(das Abo beginnt mit dem Tag der Zahlung und endet automatisch nach <?=$row["abo_days"]?> Tagen)</td>
						<td style="width:30%;">
