...
file_put_contents('request.txt', date('Y-m-d H:i:s') . ': ' . var_export($result, true) . PHP_EOL, FILE_APPEND);
...
if ($content) {
    ...
    file_put_contents('response.txt', date('Y-m-d H:i:s') . ': ' . var_export($content, true) . PHP_EOL, FILE_APPEND);
