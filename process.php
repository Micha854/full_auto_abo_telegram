                ...
                */
                ...
                if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"]))
                {
                    ...
                    if($statement == "insert") {
                        ...
                        mysqli_query($mysqli, "UPDATE ".$tbl." SET Amount = $amountInsert, TransID = '$TansID', paydate = now(), endtime = DATE_ADD(NOW(),INTERVAL $days_to_end DAY), info = NULL WHERE id = ".$update["id"]);
